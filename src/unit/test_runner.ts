...
import { createRegistry } from '../common/common/index.ts'
import type { IGrammarConfig } from '../common/common/model.ts'
import { err, ok, type Result } from '../common/result/index.ts'
